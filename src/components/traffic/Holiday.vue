    ...
    <div class="wrap-cont">
      <div class="chart-handle">
        <div class="handle-box">
          <div class="handle-item" :class="{ 'active': energyType === 1 }" @click="switchEnergyType(1)">水</div>
          <div class="handle-item" :class="{ 'active': energyType === 2 }" @click="switchEnergyType(2)">电</div>
        </div>
        <div class="handle-box">
...
const switchEnergyType = (val) => {
  energyType.value = val
  emit('updateData')
}
