      ...
      <div class="ratio-wrap">
        ...
        <div class="ratio-box">
          <div class="data f-w-900">
            <div>18%</div>
            <img class="icon-up-down" src="../assets/home/down.png" alt="" />
            <div>0%</div>
          </div>
          <div class="ratio-name">入区率</div>
        </div>
        <div class="ratio-box">
          <div class="data f-w-900">8:2</div>
          <div class="ratio-name">客货比</div>
        </div>
        <div class="ratio-box">
          <div class="data">
            <div class="f-w-900">20</div>分
            <img class="icon-up-down" src="../assets/home/up.png" alt="" />
            <div class="f-w-900">0%</div>
          </div>
      ...
      <div class="content-left animate__animated animate__fadeInLeft">
          ...
          <div class="wrap-cont">
            <div class="chart-handle">
              <div class="handle-box">
                <div class="handle-item">年</div>
                <div class="handle-item active">月</div>
                <div class="handle-item">日</div>
              </div>
            </div>
            <shop-chart class="bar-chart" :dataSource="shopData" />
          </div>
        </div>
        <div class="wrap">
        ...
        <div class="wrap">
          ...
          <div class="wrap-cont">
            ...
            <passenger-chart :dataSource="passengerData" />
          </div>
        </div>
      </div>
          ...
          <div class="energy-box">
            <div class="energy-item">
              <div class="item-content">
                ...
                <div class="energy-right"><img class="icon-up-down" src="../assets/home/down.png" alt="" />0%</div>
              </div>
            </div>
            <div class="energy-item">
              <div class="item-content">
        ...
        <div class="wrap equipment">
          ...
          <div class="equipment-box">
            <div class="equipment-item">
              <div class="item-content">
                <div>总数</div>
                <div class="equipment-data">999</div>
              </div>
            </div>
            <div class="equipment-item">
              <div class="item-content">
                <div>在线率</div>
                <div class="equipment-data">79%</div>
              </div>
            </div>
            <div class="equipment-item">
              <div class="item-content">
                <div>故障</div>
                <div class="equipment-data error">6</div>
              </div>
            </div>
          </div>
          <div class="wrap-cont">
